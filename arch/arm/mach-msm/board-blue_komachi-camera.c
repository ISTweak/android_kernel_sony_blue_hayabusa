...
#if !defined(CONFIG_SONY_CAM_MAIN_V4L2)
...
#ifdef CONFIG_SONY_CAM_SUB_V4L2
	{
		I2C_BOARD_INFO("sony_sensor_sub", 0x3d),
...
static const struct sony_sensor_module sensor_main_modules[] = {
	...
	{ "KMO08BN0", sensor_main_power_on, sensor_main_power_off },
	{ "SOI08BN1", sensor_main_power_on, sensor_main_power_off },
};
